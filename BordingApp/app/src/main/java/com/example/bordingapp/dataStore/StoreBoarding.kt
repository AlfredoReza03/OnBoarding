package com.example.bordingapp.dataStore
...
class StoreBording(private val context: Context) {
    companion object {
    ...
    val getStoreBording: Flow<Boolean?> = context.dataStore.data
        .map { preferences -> preferences[STORE_BOARD] ?: false }

    suspend fun saveBording(value: Boolean) {
